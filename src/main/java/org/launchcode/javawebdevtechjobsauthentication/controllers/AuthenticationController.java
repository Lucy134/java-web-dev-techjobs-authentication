...
import org.launchcode.javawebdevtechjobsauthentication.models.LoginDTO;
import org.launchcode.javawebdevtechjobsauthentication.models.RegistrationDTO;
...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegistrationDTO registrationDTO,
        ...
        if (existingUser != null) {
            errors.rejectValue("username", "username.alreadyexists", "Username must be unique");
            model.addAttribute("title", "Register");
            return "register";
        }
